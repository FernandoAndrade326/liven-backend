...
<h3>Tecnologias</h3>
<ul>
   <li><b>PHP: O PHP compõe 100% da linguagem de programação da API. Responsável pela interação com o banco de dados, manipulação e exibição dos dados retornados pelos endpoints após a requisição.</b></li>
